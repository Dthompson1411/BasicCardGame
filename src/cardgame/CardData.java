...
public class CardData
{
      ...
      *
      * @param id The id value of the card (0 to 12)
     ...
     /**
      * Returns the Suit of the card (Spades, Hearts, Clubs and Diamonds) Note:
      * If netbeans is true, an image is displayed; otherwise, text is
      * displayed.
      *
      * @param id The id value of the card (0 to 51).
      * @param netbeans True if using NetBeans; otherwise, false.
      * @return the Suit of the card (Spades, Hearts, Clubs and Diamonds).
      */
